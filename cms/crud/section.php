...
if ( $activity === "/" || $activity === "") {
  ...
  require_once DIR . "cms/crud/section/view.php";
...
if ( $activity === "add" ) {
  ...
  if ( isset($_POST["add"]) & 
    ...
    require_once DIR . "cms/crud/section/add.php";
...
if ( $activity === "edit" && !empty($activity_id) ) {
      ...
      require_once DIR . "cms/crud/section/edit.php";
...
if ( $activity === "delete" && !empty($activity_id) ) {
  ...
  if ( isset($_POST["delete"]) && 
      ...
      require_once DIR . "cms/crud/section/delete.php";
