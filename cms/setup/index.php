...
$sql[] = "INSERT INTO section (name, page, title, description, is_active) VALUES ('articles', 'articles', 'Articles', 'All articles in one place', 1)";
...
$sql[] = "INSERT INTO tag (name, page, type, is_active) VALUES ('thoughts', 'thoughts', 'Thoughts', 1)";
...
$sql[] = "INSERT INTO article (posted, archiving, title, title_url, description, body, user_id, section_id, tag_id, is_active) 
