  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      ...
      <label for="is_active">Is active?</label>
        ...
        <div id="tag_fields">
<?php
  $tags = $tag->getArticleTags($articleContent["article_id"]);
  $countTag = 0;
  $numTag = count($tags);
  foreach ($tags as $tag) {
    echo '<div id="positionTag'.$countTag.'">
          Tag: <select class="form-control" name="tag_id'.$countTag.'">
          <option value="' . $tag["tag_id"] . '">' . $tag["name"] . '</option></select>
